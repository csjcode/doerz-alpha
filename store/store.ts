...
type ActionWalletStore = {
  updatePublicWalletCurrent: (network: StateWalletStore['publicWalletCurrent']) => void
}



const useNetworkStore = create<StateNetworkStore & ActionNetworkStore>((set) => ({
...
const useWalletStore = create<StateWalletStore & ActionWalletStore>((set) => ({
  publicWalletCurrent: "",
  updatePublicWalletCurrent: (newPublicWalletCurrent:string) => set({ publicWalletCurrent: newPublicWalletCurrent }),
}))
